...

    {
      ...
      sections: [
        ...
        { title: '会员福利', fields: [
          ...
          { key: 'index.benefits.item.2.title', label: '权益3 · 标题', type: 'text', value: '会员企业网站' },
          { key: 'index.benefits.item.2.body', label: '权益3 · 描述', type: 'textarea', value: '打造会员企业网站，推荐会员业务，促进会员之间的合作与引荐。' },
        ...
        { title: '团队与顾问', fields: [
          ...
          { key: 'index.leaders.person.0.name', label: '成员1 · 姓名', type: 'text', value: '杨照林' },
          ...
          { key: 'index.leaders.person.1.name', label: '成员2 · 姓名', type: 'text', value: '[ 总监姓名 ]' },
          ...
          { key: 'index.leaders.person.2.name', label: '成员3 · 姓名', type: 'text', value: '[ 顾问姓名 ]' },
          ...
          { key: 'index.leaders.person.3.name', label: '成员4 · 姓名', type: 'text', value: '[ 顾问姓名 ]' },
        ...
        { title: '底部行动区 CTA', fields: [
          { key: 'index.cta.eyebrow', label: '小标题', type: 'text', value: '资格与费用 · Membership' },
          { key: 'index.cta.title', label: '标题（换行用回车）', type: 'textarea', value: '全球限额 100 位\n受邀制高端社群' },
          { key: 'index.cta.text1', label: '正文1', type: 'textarea', value: '入会资格：具有一定实力的企业家、有潜力的青年创始人（含企业家二代）。申请方法：会员推荐，理事会审批。' },
          { key: 'index.cta.text2', label: '正文2', type: 'textarea', value: '入会申请费 2,000 新币 · 年费 100 新币（中国境内 12,000 / 800 元人民币）。' },
        ]},
      ]
    },

    {
      ...
      sections: [
        ...
        { title: '团队与顾问', fields: [
          ...
          { key: 'about.leaders.person.0.name', label: '成员1 · 姓名', type: 'text', value: '杨照林' },
          ...
          { key: 'about.leaders.person.1.name', label: '成员2 · 姓名', type: 'text', value: '[ 总监姓名 ]' },
          ...
          { key: 'about.leaders.person.2.name', label: '成员3 · 姓名', type: 'text', value: '[ 顾问姓名 ]' },
          ...
          { key: 'about.leaders.person.3.name', label: '成员4 · 姓名', type: 'text', value: '[ 顾问姓名 ]' },
...

    {
      ...
      sections: [
        ...
        { title: '会员权益', fields: [
          ...
          { key: 'membership.benefit.2.title', label: '权益3 · 标题', type: 'text', value: '会员企业网站' },
          { key: 'membership.benefit.2.body', label: '权益3 · 描述', type: 'textarea', value: '为会员企业打造官方网站，推荐会员业务，促进会员之间的合作与引荐。' },
        ...
        { title: '入会资格', fields: [
          ...
          { key: 'membership.eligibility.prose', label: '正文（多段，可加粗）', type: 'rich', value: '<p class="lead">IE100 采用会员推荐、理事会审批的甄选机制，会员数量上限 100 人，宁缺毋滥。</p>\n<p><strong>入会资格 ·</strong> 具备一定实力的企业家。</p>\n<p><strong>申请方法 ·</strong> 会员推荐，理事会审批。</p>\n<p><strong>国际会员来自 ·</strong> 新加坡、中国、东南亚、欧美，以华文为交流语言的各国企业家。</p>\n<p><strong>主席 ·</strong> 杨照林，轮值主席每年一位。</p>' },
        ]},
        { title: '会员费用', fields: [
          { key: 'membership.fees.eyebrow', label: '小标题', type: 'text', value: '会员费用' },
          { key: 'membership.fees.title', label: '标题（换行用回车）', type: 'textarea', value: '透明的\n会员费用' },
          { key: 'membership.fee.0.label', label: '费用1 · 名称', type: 'text', value: '会员申请费（一次性）' },
          { key: 'membership.fee.0.value', label: '费用1 · 金额', type: 'text', value: '2,000 新币' },
          { key: 'membership.fee.1.label', label: '费用2 · 名称', type: 'text', value: '年费' },
          { key: 'membership.fee.1.value', label: '费用2 · 金额', type: 'text', value: '100 新币' },
          { key: 'membership.fee.2.label', label: '费用3 · 名称', type: 'text', value: '中国境内 · 申请费' },
          { key: 'membership.fee.2.value', label: '费用3 · 金额', type: 'text', value: '12,000 元人民币' },
          { key: 'membership.fee.3.label', label: '费用4 · 名称', type: 'text', value: '中国境内 · 年费' },
          { key: 'membership.fee.3.value', label: '费用4 · 金额', type: 'text', value: '800 元人民币' },
          { key: 'membership.fee.4.label', label: '费用5 · 名称', type: 'text', value: '会员名额' },
          { key: 'membership.fee.4.value', label: '费用5 · 金额', type: 'text', value: '全球限额 100 位' },
          { key: 'membership.fees.footnote', label: '脚注', type: 'textarea', value: '* 国际企业家100俱乐部隶属于新加坡春天国际控股公司，公司对俱乐部章程拥有最终解释与修改权。' },
        ]},
        { title: '申请流程', fields: [
        ...
        { title: '申请区文案', fields: [
          ...
          { key: 'membership.apply.title', label: '标题', type: 'text', value: '提交您的入会意向' },
...

    {
      ...
      sections: [
        ...
        { title: '官方联系方式', fields: [
          ...
          { key: 'contact.info.item.0.label', label: '项1 · 名称', type: 'text', value: '秘书电邮' },
          { key: 'contact.info.item.0.value', label: '项1 · 内容', type: 'text', value: '1796734768@qq.com' },
          { key: 'contact.info.item.1.label', label: '项2 · 名称', type: 'text', value: '秘书微信' },
          { key: 'contact.info.item.1.value', label: '项2 · 内容', type: 'text', value: 'scilearning' },
          { key: 'contact.info.item.2.label', label: '项3 · 名称', type: 'text', value: '办公地址' },
          { key: 'contact.info.item.2.value', label: '项3 · 内容', type: 'text', value: '[ 上海市 · 办公地址待补充 ]' },
...
window.IE100_FORMS_DEFAULT = {
  ...
  contact: {
    ...
    fields: {
      ...
      phone:   { label: '联系电话', placeholder: '+86 ', required: false },
